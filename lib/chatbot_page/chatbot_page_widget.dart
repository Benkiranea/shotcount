...
class ChatbotPageWidget extends StatefulWidget {
  ...
  static String routeName = 'ChatbotPage';
  static String routePath = '/chatbotPage';
          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  color: FlutterFlowTheme.of(context).choiceClr,
                ...
                child: Padding(
                  padding:
                      EdgeInsetsDirectional.fromSTEB(20.0, 13.0, 20.0, 14.0),
                  child: Row(
                    mainAxisSize: MainAxisSize.max,
                    children: [
                      Expanded(
                            ...
                            decoration: InputDecoration(
                              ...
                              enabledBorder: OutlineInputBorder(
                                borderSide: BorderSide(
                                  color:
                                      FlutterFlowTheme.of(context).backIconClr,
                                  width: 1.0,
                                ),
                              ...
                              filled: true,
                              fillColor: FlutterFlowTheme.of(context).choiceClr,
                            ),
                            style: FlutterFlowTheme.of(context)
                                .bodyMedium
                                .override(
