  ...
  try {
    ...
    switch (paramType) {
      ...
      case ParamType.SupabaseRow:
        ...
        switch (T) {
          case AppSecretsRow:
            return AppSecretsRow(data);
          case GoogleBusinessConfigRow:
            return GoogleBusinessConfigRow(data);
          case GoogleReviewsRow:
            return GoogleReviewsRow(data);
          case InstagramPostsRow:
            return InstagramPostsRow(data);
          case ProfilesRow:
