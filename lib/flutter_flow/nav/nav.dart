...
class AppStateNotifier extends ChangeNotifier {
  ...
  ShotcountAuthUser? initialUser;
  ShotcountAuthUser? user;
  ...
  void update(ShotcountAuthUser newUser) {
    final shouldUpdate =
...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: CustomerRightsPageWidget.routeName,
          path: CustomerRightsPageWidget.routePath,
          builder: (context, params) => CustomerRightsPageWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
          name: HeritagePageWidget.routeName,
          path: HeritagePageWidget.routePath,
          builder: (context, params) => HeritagePageWidget(),
        ),
        FFRoute(
          name: GreatnessPageWidget.routeName,
          path: GreatnessPageWidget.routePath,
          builder: (context, params) => GreatnessPageWidget(),
        ),
        FFRoute(
          name: TestimonialsPageWidget.routeName,
          path: TestimonialsPageWidget.routePath,
          builder: (context, params) => TestimonialsPageWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
          name: YourProjectsPageWidget.routeName,
          path: YourProjectsPageWidget.routePath,
          builder: (context, params) => YourProjectsPageWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
          name: ProjectPageWidget.routeName,
          path: ProjectPageWidget.routePath,
        ...
        FFRoute(
          name: Step5Widget.routeName,
          path: Step5Widget.routePath,
        ...
        FFRoute(
          name: Step6Widget.routeName,
          path: Step6Widget.routePath,
        ...
        FFRoute(
          name: YourProjectDetailPageWidget.routeName,
          path: YourProjectDetailPageWidget.routePath,
          builder: (context, params) => YourProjectDetailPageWidget(
            projectId: params.getParam(
              'projectId',
              ParamType.String,
            ),
