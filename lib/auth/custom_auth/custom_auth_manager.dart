...
class CustomAuthManager {
  ...
  Future signOut() async {
    ...
    shotcountAuthUserSubject.add(
      ShotcountAuthUser(loggedIn: false),
    );
  ...
  Future<ShotcountAuthUser?> signIn({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
  ...
  Future<ShotcountAuthUser?> _updateCurrentUser({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
    ...
    final updatedUser = ShotcountAuthUser(
      loggedIn: true,
      uid: authUid,
    );
    shotcountAuthUserSubject.add(updatedUser);
