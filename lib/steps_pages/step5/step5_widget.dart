                      ...
                      children: [
                        ...
                        Padding(
                          padding: EdgeInsetsDirectional.fromSTEB(
                              0.0, 2.0, 0.0, 0.0),
                          child: Text(
                            'Your project is scheduled. We look forward to elevating your space.',
                        ...
                        Padding(
                          ...
                          child: FutureBuilder<ApiCallResponse>(
                            ...
                            builder: (context, snapshot) {
                              ...
                              final containerGetProjectDetailsResponse =
                                  snapshot.data!;
                              ...
                              return Container(
                                ...
                                child: Padding(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      wrapWithModel(
                                        model: _model.stepsContainerModel,
                                        updateCallback: () =>
                                            safeSetState(() {}),
                                        child: StepsContainerWidget(
                                          ...
                                          description:
                                              'We’ve reserved your spot on our schedule',
                                          image:
                                              'https://storage.googleapis.com/flutterflow-io-6f20.appspot.com/projects/shot-tracker-9ge9rk/assets/42e3xebuo9sk/calendar-2.png',
                                        ),
                                      ),
                                      Column(
                                        mainAxisSize: MainAxisSize.max,
                                                  ...
                                                  ClipRRect(
                                                    borderRadius:
                                                        BorderRadius.circular(
                                                            8.0),
                                                    child: Image.asset(
                                                      'assets/images/documentImage.png',
                                                      width: 20.0,
                                                      height: 20.0,
                                                      fit: BoxFit.cover,
                                                    ),
                                                  ...
                                                  ClipRRect(
                                                    borderRadius:
                                                        BorderRadius.circular(
                                                            8.0),
                                                    child: Image.asset(
                                                      'assets/images/Frame_2147226207.png',
                                                      width: 20.0,
                                                      height: 20.0,
                                                      fit: BoxFit.cover,
                                                    ),
                        ...
                        Text(
                          'Your appointment has been schedule.\nYou will receive confirmation forms by email.',
                          textAlign: TextAlign.center,
                          style:
                              FlutterFlowTheme.of(context).bodyMedium.override(
                                    font: GoogleFonts.playfair(
                        ...
                        Padding(
                          padding: EdgeInsetsDirectional.fromSTEB(
                              0.0, 2.0, 0.0, 0.0),
                          child: Text(
                            'You’ll receive a reminder 24 hours before your scheduled date.',
                            textAlign: TextAlign.center,
                            style: FlutterFlowTheme.of(context)
                                .bodyMedium
                                .override(
