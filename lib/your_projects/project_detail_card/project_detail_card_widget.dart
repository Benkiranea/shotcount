...
import 'project_detail_card_model.dart';
export 'project_detail_card_model.dart';

class ProjectDetailCardWidget extends StatefulWidget {
  const ProjectDetailCardWidget({
    super.key,
    required this.title,
...
class _ProjectDetailCardWidgetState extends State<ProjectDetailCardWidget> {
  late ProjectDetailCardModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ProjectDetailCardModel());
  }
